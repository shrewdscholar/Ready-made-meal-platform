  ...
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="账号" prop="dianpumingcheng">
          <el-input v-model="ruleForm.dianpumingcheng" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="姓名" prop="shangjiaxingming">
          <el-input v-model="ruleForm.shangjiaxingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='shangjia'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="手机" prop="lianxidianhua">
