<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="账号" prop="dianpumingcheng">
					<el-input v-model="ruleForm.dianpumingcheng" placeholder="账号" clearable  :readonly="ro.dianpumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="账号" prop="dianpumingcheng">
					<el-input v-model="ruleForm.dianpumingcheng" placeholder="账号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="姓名" prop="shangjiaxingming">
					<el-input v-model="ruleForm.shangjiaxingming" placeholder="姓名" clearable  :readonly="ro.shangjiaxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="姓名" prop="shangjiaxingming">
					<el-input v-model="ruleForm.shangjiaxingming" placeholder="姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="手机" prop="lianxidianhua">
					<el-input v-model="ruleForm.lianxidianhua" placeholder="手机" clearable  :readonly="ro.lianxidianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="手机" prop="lianxidianhua">
					<el-input v-model="ruleForm.lianxidianhua" placeholder="手机" readonly></el-input>
				</el-form-item>
			</template>
