	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商户名称" prop="dianpumingcheng">
					<el-input v-model="ruleForm.dianpumingcheng" placeholder="商户名称" clearable  :readonly="ro.dianpumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商户名称" prop="dianpumingcheng">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springboot01u2zqkf/upload');
        } else {
