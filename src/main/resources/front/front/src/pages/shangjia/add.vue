...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    <el-form
      ...
      label-width="150px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="账号" prop="dianpumingcheng">
            <el-input v-model="ruleForm.dianpumingcheng" 
                placeholder="账号" clearable :disabled=" false  ||ro.dianpumingcheng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="姓名" prop="shangjiaxingming">
            <el-input v-model="ruleForm.shangjiaxingming" 
                placeholder="姓名" clearable :disabled=" false  ||ro.shangjiaxingming"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="手机" prop="lianxidianhua">
            <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="手机" clearable :disabled=" false  ||ro.lianxidianhua"></el-input>
          </el-form-item>
