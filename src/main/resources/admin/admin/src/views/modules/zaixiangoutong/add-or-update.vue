	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="交流内容" prop="jiaoliuneirong">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jiaoliuneirong" label="交流内容" prop="jiaoliuneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiaoliuneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiaoliuneirong = this.ruleForm.jiaoliuneirong.replace(reg,'../../../springboot01u2zqkf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
